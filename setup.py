...
setup(
  name = 'ePaperLibrary',         # How you named your package folder (MyLib)
  packages = ['ePaperLibrary'],   # Chose the same as "name"
  ...
  download_url = 'https://github.com/glints/ePaperLibrary/archive/01.tar.gz',    # I explain this later on
